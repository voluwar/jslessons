...
// - 7 - number, string, boolean, symbol, null, undefined, object
// Как вывести информацию в консоль? console.log('что хотим вывести')
// Какая функция операторов || и &&? выводит true в случае, если true хотя бы одно или все из сравниваемых значений сооветственно
...
var expenses = {
    ...
    secondQustions: prompt('Во сколько обойдется?')
    };
